...
auto ADHM::custom_BPS() -> void {
  ...
  auto path_it_A = get_iterator_by_id(new_paths_, 5);
  auto path_it_B = get_iterator_by_id(new_paths_, 6);
  auto inter = two_path_intersections(path_it_A, path_it_B).at(0);
  ...
  two_path_intersection_handler(2,7, false, true, 0,0, false, false);
  save_data(7);
