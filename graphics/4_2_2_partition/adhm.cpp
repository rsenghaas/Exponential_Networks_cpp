...
auto ADHM::custom_BPS() -> void {
  ...
  two_path_intersection_handler(1,4, false, true, -3, 0, false, false);
  save_data(4);
  ...
  two_path_intersection_handler(7,6, true, true, -2,0, true, true);
  save_data(6);
  save_data(7);
  ...
  two_path_intersection_handler(1,9, false, true, -1, 0, true, true);
  save_data(9);
