...
auto ADHM::custom_BPS() -> void {
  ...
  two_path_intersection_handler(2, 3, false, false, 0, 0, true, false);  
  path_it = get_iterator_by_id(new_paths_, 4);
  evolve_path(path_it, kCutoff);
  save_data(4);
  ...
  two_path_intersection_handler(0, 3, false, true, 0, 0, true, false);
  path_it = get_iterator_by_id(new_paths_, 7);
  evolve_path(path_it, kCutoff);
  save_data(7);


  two_path_intersection_handler(2, 3, true, false, 0, 0, true, false);  
  save_data(2);
  save_data(3);
  ...
  two_path_intersection_handler(5, 6, true, true, 2, 0, false, false);
  path_it = get_iterator_by_id(new_paths_, 7);
  evolve_path(path_it, kCutoff);
  save_data(5);
  save_data(6);
  ...
  save_data(8);
  get_iterator_by_id(new_paths_, 9);
  evolve_path(path_it, kCutoff);
  save_data(9);*/
