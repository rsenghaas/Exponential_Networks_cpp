...
auto ADHM::custom_BPS() -> void {
  ...
  two_path_intersection_handler(1,4, false, true, -2, 0, false, false);
  save_data(4);

  path_it = get_iterator_by_id(new_paths_, 6);
  evolve_path(path_it, kCutoff);
  two_path_intersection_handler(2,6, false, true, 0,0, false, false);
  save_data(6);

  path_it = get_iterator_by_id(new_paths_, 7);
  evolve_path(path_it, kCutoff);
  two_path_intersection_handler(1, 7, false, true, -2, 0, false, false);
  save_data(7);
  ...
  two_path_intersection_handler(5,8, true, true, -1,0, true, false);
  save_data(5);
  save_data(8);
