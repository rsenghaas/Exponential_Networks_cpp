...
path_colors = {0: Morange, 4: Morange,a 7: Mblue, 8: Mblue}

# 12 15

partition = 'Coni_D0_D2'
    ...
    for k in range(30, 31):
        ...
        for file in glob.glob("*.csv"):
            ...
            if i in path_colors:
                ...
                order = 1
                color = grey
            plt.plot(x_data.real, x_data.imag, linewidth=1.3, color=color,
                     zorder=order)
        ...
        plt.savefig(output_dir + f'/network_{k}.png', dpi=fig.dpi)
