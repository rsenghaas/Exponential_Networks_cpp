...
path_colors = {3: red, 5 :green, 7: green, 9: green, 11: red}

partition = '2_1_partition'
...
if True:
    ...
    plt.plot(log_cut_plus, 0*log_cut_plus, 
             ...
             zorder=0, linewidth=0.1)
    ''' 
    plt.text(-0.65, 0.25, "3")
    plt.text(-0.65, -0.27, "2") 
    plt.plot([-0.865, -0.8], [0, 0.15], color=black, linewidth=0.2)
    plt.plot([-0.85, -0.77], [0, 0.15], color=black, linewidth=0.2)
    #plt.plot([-0.849, -0.74], [0, 0.15], color=black, linewidth=0.2)
    plt.text(-0.795, 0.14, "2")
    plt.text(-0.765, 0.14, "1")
    #plt.text(-0.735, 0.14, "1")
    plt.plot([-1.356, -1.5], [-0.04, 0.25], color=black, linewidth=0.2)
    # plt.plot([-1.37, -1.53], [-0.04, 0.25], color=black, linewidth=0.2)
    plt.text(-1.515, 0.24, "1")
    # plt.text(-1.545, 0.24, "1")
    plt.text(-1.5, -0.04, "1")       # plt.text(-0.65, 0.25, r"$(+-)_0$")
    # plt.text(-0.65, -0.28, r"$(+-)_0$")  

    plt.axis([-1.8, 0.1, -0.57, 0.43])
    ax =plt.gca()
