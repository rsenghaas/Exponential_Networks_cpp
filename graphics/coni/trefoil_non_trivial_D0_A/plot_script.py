...
path_colors = {1:black, 2: black, 3: black, 4: black, 11:black, 9: black, 22:
               black, 20:black, 14: black, 16: black, 23: black, 24:black, 15:
               black, 17: black}
# path_colors = {0: green, 1: grey, 2: blue, 3:red, 4: green}

partition = 'trefoil_non_trivial_D0_A'
...
if sys.argv[1] == "all":
    ...
    for file in glob.glob("*.csv"):
        ...
        if ( 
            i in [1,2,3,4,9,11,22] + [0,5,10,21,24] # [18,19,20,21,22,23]
        ): # [3, 6, 21, 25]                                             
            continue
        print(i)
