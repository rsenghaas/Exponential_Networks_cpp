...
path_colors = {1:black, 2: black, 3: black, 4: black, 11:black, 9: black,
               20:black,  22:
               black, 5: black, 7: black, 23: red}
# path_colors = {0: green, 1: grey, 2: blue, 3:red, 4: green}

partition = 'trefoil_non_trivial_D0_B'
...
if sys.argv[1] == "all":
    ...
    for file in glob.glob("*.csv"):
        ...
        if ( 
            i in [1,2,3,4,11,20,22] + [24] # [18,19,20,21,22,23]
        ): # [3, 6, 21, 25]                                             
            continue
        print(i)
