...
if sys.argv[1] == "all":
    ...
    for file in glob.glob("*.csv"):
        ...
        if i in []:
            order = 4
        plt.plot(x_data.real, x_data.imag, linewidth=1.5, color=color,
                 zorder=order)
    ...
    plt.plot(branch_tf.real, branch_tf.imag, color=orange, marker='x',
             markersize=3,
             fillstyle='none', linestyle='none', mew=0.1, zorder=5)
